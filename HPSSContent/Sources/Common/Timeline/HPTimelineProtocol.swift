...
protocol HPTimelineTransactionProtocol {
...
protocol HPTimelineOperationProtocol {
    static var reset: Self { get }
}

protocol HPTimelinePointProtocol {
...
protocol HPTimelineEditorProtocol {
